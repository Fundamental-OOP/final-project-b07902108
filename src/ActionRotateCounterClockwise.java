...
public class ActionRotateCounterClockwise extends BoardAction {
    private Tetromino tetromino;

    public ActionRotateCounterClockwise() {
        this.name = "RTC";
    }

    public ActionRotateCounterClockwise(Board board) {
        this.name = "RTC";
        this.board = board;
    ...
    protected BoardAction copyAction(Board board) {
        return new ActionRotateCounterClockwise(board);
    }
